...
class RegularMovieCalculationStrategy extends AbstractCalculationStrategy {
    private static final long BASIC_RENT = 30;
    private static final int BASIC_RENTAL_DAYS = 3;
